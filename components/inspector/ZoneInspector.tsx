      ...
      <DockBody>
        ...
        {z.type !== "aisle" && z.type !== "open" ? (
          <Section
            title="Doors"
            aside={
              <button className="text-[11.5px] text-accent underline" onClick={() => setTool("interiorDoor")} title="Then click one of this stall's walls in the plan">
                + Add a door
              </button>
            }
          >
            {doors.length ? (
              ...
              <p className="text-[12px] text-muted">No door. {z.autoDoor ? "It doesn't touch an aisle yet." : ""}</p>
            )}
