...
export const PRICES: PriceItem[] = [
  ...
  { sku: "elec.gooseneck", description: "Gooseneck barn light, 14\" shade, LED", unit: "each", unitCost: 95, category: "electrical", source: "placeholder" },
  { sku: "elec.lantern", description: "Exterior wall lantern, LED", unit: "each", unitCost: 70, category: "electrical", source: "placeholder" },
  // Looks (ADR-0018): cupola, weathervane, awnings, trim boards, wainscot
  { sku: "cupola.24", description: "Cupola, 24\" base, louvered, metal roof", unit: "each", unitCost: 450, category: "trim", source: "placeholder" },
  { sku: "cupola.30", description: "Cupola, 30\" base, louvered, metal roof", unit: "each", unitCost: 650, category: "trim", source: "placeholder" },
  { sku: "cupola.36", description: "Cupola, 36\" base, louvered, metal roof", unit: "each", unitCost: 900, category: "trim", source: "placeholder" },
  { sku: "cupola.42", description: "Cupola, 42\" base, louvered, metal roof", unit: "each", unitCost: 1250, category: "trim", source: "placeholder" },
  { sku: "cupola.48", description: "Cupola, 48\" base, louvered, metal roof", unit: "each", unitCost: 1600, category: "trim", source: "placeholder" },
  { sku: "cupola.windowed", description: "Windowed cupola upcharge", unit: "each", unitCost: 250, category: "trim", source: "placeholder" },
  { sku: "weathervane", description: "Weathervane with roof mount", unit: "each", unitCost: 140, category: "trim", source: "placeholder" },
  { sku: "cupola.saddle", description: "Cupola saddle cut and flashing", unit: "each", unitCost: 120, category: "trim", source: "placeholder" },
  { sku: "awning.lf", description: "Bracketed awning roof: rafters, purlins, steel, fascia, flashing (per foot of width)", unit: "lf", unitCost: 42, category: "trim", source: "placeholder" },
  { sku: "awning.bracket.timber", description: "Timber knee bracket, 6×6 rough sawn, with lags", unit: "each", unitCost: 85, category: "trim", source: "placeholder" },
  { sku: "awning.bracket.steel", description: "Steel awning bracket, powder coated", unit: "each", unitCost: 60, category: "trim", source: "placeholder" },
  { sku: "trim.1x4.lf", description: "1×4 trim board, primed or composite", unit: "lf", unitCost: 1.6, category: "trim", source: "placeholder" },
  { sku: "trim.1x6.lf", description: "1×6 trim board, primed or composite", unit: "lf", unitCost: 2.4, category: "trim", source: "placeholder" },
  { sku: "trim.cap.lf", description: "1×2 drip cap over head trim", unit: "lf", unitCost: 1.1, category: "trim", source: "placeholder" },
  { sku: "wainscot.stone.sqft", description: "Stone veneer wainscot, installed on lath, with cap", unit: "sqft", unitCost: 22, category: "siding", source: "placeholder" },
  { sku: "wainscot.board.sqft", description: "Board-and-batten wainscot band with drip cap", unit: "sqft", unitCost: 6.5, category: "siding", source: "placeholder" },
  { sku: "wainscot.steel.sqft", description: "Contrasting steel wainscot panel with Z-trim", unit: "sqft", unitCost: 3.2, category: "siding", source: "placeholder" },
